...
def send_slack_alert(message: str, severity: str, diagnosis: str) -> None:
    ...
    """
    with _tracer.start_as_current_span("send_slack_alert") as span:
        span.set_attribute("input.message", message[:500])
        span.set_attribute("input.severity", severity)
...
def check_existing_github_issue(query: str) -> bool:
    ...
    """
    with _tracer.start_as_current_span("check_existing_github_issue") as span:
        ...
        span.set_attribute("output.exists", False)
...
def create_github_issue(title: str, body: str) -> None:
    ...
    """
    with _tracer.start_as_current_span("create_github_issue") as span:
        span.set_attribute("input.title", title)
